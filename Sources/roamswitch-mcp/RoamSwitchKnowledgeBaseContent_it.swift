    ...
    private static func featuresItNetwork() -> [LocalizedEntry] {
        return [
            ...
            LocalizedEntry(
                ...
                summary: "Il contenimento di emergenza condiviso usato quando viene rilevata una minaccia grave (ransomware, rilevamento malware da XProtect, spoofing ARP, ClickFix). Blocca tutto il traffico in entrata e in uscita. Anche dopo un crash o un riavvio, la rete torna automaticamente entro 10 minuti al massimo.",
                details: """
                ...
                • Rilascio: rilasciare dalla finestra di emergenza o dalla notifica rimuove il blocco pf e riattiva il Wi-Fi.
                • Rete di sicurezza: se l'app va in crash o nessuno rilascia il contenimento, un timer lato helper forza il rilascio dell'Air-Gap dopo 10 minuti e ripristina il Wi-Fi. Riavviare l'app o il Mac permette anch'esso il ripristino senza passaggi manuali.
    ...
    private static func featuresItAudit() -> [LocalizedEntry] {
        return [
            ...
            LocalizedEntry(
                ...
                • Nota: i test Air-Gap interrompono davvero temporaneamente la rete. Rilascia dalla finestra di emergenza (si ripristina anche da sola entro 10 minuti).
    ...
    private static func alertsItMalware() -> [LocalizedEntry] {
        return [
            ...
            LocalizedEntry(
                ...
                • Difesa automatica: tutto il traffico interrotto più il Wi-Fi disattivato, ripristinato automaticamente entro al massimo 10 minuti se non rilasciato. Vengono registrati il processo rilevante, la categoria e il messaggio di rilevamento di Apple.
                """,
                recommendation: """
    ...
    private static func troubleshootingItOperation() -> [LocalizedEntry] {
        return [
            LocalizedEntry(
                ...
                • Ripristino automatico: anche senza rilasciarlo, la rete di sicurezza dell'helper ripristina la rete entro 10 minuti. Non è necessario alcun passaggio manuale dopo la chiusura, un crash, o un riavvio.
